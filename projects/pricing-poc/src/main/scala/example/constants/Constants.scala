...
object MigrationAssessmentSourceTypes extends Enumeration {
  ...
  val EventHubRawEventStream, Suitability, SkuRecommendationDB, SkuRecommendationMI, SkuRecommendationVM, PricingComputation, FullAssessment, InstanceUpdate = Value
}
